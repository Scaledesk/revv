    ...
    e.fn.fullpage = function(l) {
        function s(n, t) {
            ...
            l.autoScrolling && !l.scrollBar ? (rt.css({
                overflow: "hidden",
                height: "100%"
            }), U(Mt.recordHistory, "internal"), vt.css({
        ...
        function ve(n) {
            var t = lt.hasClass(c);
            n ? t || (s(!1, "internal"), Z(!1, "internal"), e(A).hide(), lt.addClass(c), e.isFunction(l.afterResponsive) && l.afterResponsive.call(vt, n)) : t && (s(Mt.autoScrolling, "internal"), Z(Mt.autoScrolling, "internal"), e(A).show(), lt.removeClass(c), e.isFunction(l.afterResponsive) && l.afterResponsive.call(vt, n))
        }
        ...
        function De(n) {
            ...
            if (!Pe(n.target) && qe(t)) {
                ...
                var a = l.scrollOverflowHandler.scrollable(i),
                    r = Jn(t);
                zt = r.y, Dt = r.x, i.find(q).length && o.abs(Bt - Dt) > o.abs(Rt - zt) ? !ut && o.abs(Bt - Dt) > ne.outerWidth() / 100 * l.touchSensitivity && (Bt > Dt ? bt.m.right && ue(i) : bt.m.left && he(i)) : l.autoScrolling && St && o.abs(Rt - zt) > ne.height() / 100 * l.touchSensitivity && (Rt > zt ? Be("down", a) : zt > Rt && Be("up", a))
            }
        }
        ...
        function Ne(e) {
            ...
            return e.outerHeight() > gt ? (!o && !a || "bottom" === a) && (t = i) : (o || mt && e.is(":last-child")) && (t = i), qt = t, t
        }
        ...
        function sn(e) {
            2 == e.which && (Ft = e.pageY, vt.on("mousemove", vn))
        }
        ...
        function vn(e) {
            St && (e.pageY < Ft && bt.m.up ? se() : e.pageY > Ft && bt.m.down && ce()), Ft = e.pageY
        }
        ...
        function yn() {
            if (bn(), ht) {
                ...
                if (!n.is("textarea") && !n.is("input") && !n.is("select")) {
                    var i = ne.height();
                    o.abs(i - Vt) > 20 * o.max(Vt, i) / 100 && (pe(!0), Vt = i)
                }
        ...
        function Kn() {
            (ht || pt) && (l.autoScrolling && lt.off(At.touchmove).on(At.touchmove, ze), e(r).off(At.touchstart).on(At.touchstart, Fe).off(At.touchmove).on(At.touchmove, De))
        }

        function Qn() {
            (ht || pt) && e(r).off(At.touchstart).off(At.touchmove)
        }
        ...
        function Zn(e, n) {
            Q(0, "internal"), "undefined" != typeof n && (mt = !0), gn(e.closest(q), e), "undefined" != typeof n && (mt = !1), Q(Mt.scrollingSpeed, "internal")
        }
